// ----------------------------------------------------------
// <copyright file="GetLanguagesForSpeakAgent.cs" company="Microsoft">
...
namespace Microsoft.Hawaii.Translator.Client
{
    ...
    /// </summary>
    internal class GetLanguagesForSpeakAgent : ServiceAgent<GetLanguagesForSpeakResult>
    {
        /// <summary>
        ...
        public GetLanguagesForSpeakAgent(string hostName, ClientIdentity identity, string locale = "en") :
        ...
        /// <param name="locale">The local system locale</param>
        public GetLanguagesForSpeakAgent(string hostName, ClientIdentity identity, object stateObject, string locale = "en") :
        ...
        protected override void ParseOutput(System.IO.Stream responseStream)
        {
            ...
            this.Result.SupportedLanguages = DeserializeResponseJson<GetLanguagesForSpeakResult>(responseStream).SupportedLanguages;
        ...
        private Uri CreateServiceUri(string hostName, string locale)
        {
            string signature = string.Format(
                ...
                TranslatorService.GetLanguagesForSpeakKey, 
