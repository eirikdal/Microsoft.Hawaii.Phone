// ----------------------------------------------------------
// <copyright file="SetAgent.cs" company="Microsoft">
...
namespace Microsoft.Hawaii.KeyValue.Client
{
    ...
    /// <summary>
    /// Class agent to set key value item.
    /// </summary>
    internal class SetAgent : ServiceAgent<SetResult>
    {
        /// <summary>
        /// The KeyValue items to set.
        /// </summary>
        private KeyValueItem[] items;

        /// <summary>
        /// Initializes a new instance of the SetAgent class.
        /// </summary>
        ...
        public SetAgent(string hostName, ClientIdentity clientIdentity, KeyValueItem[] items) :
        ...
        public SetAgent(string hostName, ClientIdentity clientIdentity, KeyValueItem[] items, object stateObject) :
