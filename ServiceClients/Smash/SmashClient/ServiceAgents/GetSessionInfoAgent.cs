// ----------------------------------------------------------
// <copyright file="GetSessionInfoAgent.cs" company="Microsoft">
...
namespace Microsoft.Hawaii.Smash.Client
{
    ...
    /// </summary>
    internal class GetSessionInfoAgent : AbortableServiceAgent<GetSessionInfoResponse>
    {
        /// <summary>
        /// 
        /// </summary>
        private GetSessionInfoRequest request;
        ...
        public GetSessionInfoAgent(
            string hostName,
            ClientIdentity clientIdentity,
            Guid meetingToken,
            Guid sessionID)
            : this(hostName, clientIdentity, meetingToken, sessionID, null)
        {
        }
            ...
            base(HttpMethod.Post, stateObject)
        {
            ...
            this.request = new GetSessionInfoRequest()
            {
        ...
        protected override void ParseOutput(System.IO.Stream responseStream)
        {
            ...
            this.Result = AbortableServiceAgent<GetSessionInfoResponse>.DeserializeResponseJson<GetSessionInfoResponse>(responseStream);
        ...
        protected override byte[] GetPostData()
        {
            ...
            {
                DataContractJsonSerializer serializer = new DataContractJsonSerializer(typeof(GetSessionInfoRequest));
        ...
        {
            string signature = string.Format("{0}", SmashClientREST.GetSessionInfoSignature);
