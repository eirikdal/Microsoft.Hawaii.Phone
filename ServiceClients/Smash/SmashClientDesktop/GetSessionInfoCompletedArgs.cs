// ----------------------------------------------------------
// <copyright file="GetSessionInfoCompletedArgs.cs" company="Microsoft">
...
namespace Microsoft.Hawaii.Smash.Client
{
    ...
    /// </summary>
    public class GetSessionInfoCompletedArgs : AsyncCompletedEventArgs
    {
        /// <summary>
        ...
        internal GetSessionInfoCompletedArgs(Exception error, bool cancelled, object userState)
